import { Calendar, Eye, HardDrive, Trophy, Users, Zap } from 'lucide-react';
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="font-extrabold text-white text-xs sm:text-base md:text-lg tracking-tight">
                  <span className="hidden sm:inline">Большой Теннис: ATP &amp; WTA</span>
              ...
              <p className="text-[11px] text-slate-400 hidden lg:block">
                Зрительский режим • Чередующиеся турниры ATP & WTA • Оффлайн
              </p>
            </div>
          </div>
            ...
            <button
              ...
              title={
                lastAutoSaveTime && lastAutoSaveTime > 0
                  ? `Автосохранение: сохранено в ${new Date(lastAutoSaveTime).toLocaleTimeString('ru-RU')}`
